...
TEST(positive_tests, test1)
{
    ...
    big_integer::divide(bigint_1, bigint_2, nullptr, big_integer::division_rule::BurnikelZiegler);
...
TEST(positive_tests, test2)
{
    ...
    EXPECT_THROW(big_integer::divide(bigint_1, bigint_2, nullptr, big_integer::division_rule::BurnikelZiegler), std::logic_error);
...
TEST(positive_tests, test5)
{
    ...
    big_integer result_of_division = big_integer::divide(bigint_1, bigint_2, nullptr, big_integer::division_rule::BurnikelZiegler);
